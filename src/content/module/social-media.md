...
techStack:
  ...
  - "Facebook Pages API"
benefits:
  - "Regelmäßige Präsenz auf allen Kanälen ohne manuellen Aufwand"
  - "Content-Ideen und Texte von der KI generiert"
  - "Multi-Plattform-Posting aus einer Quelle"
  - "Zeitplanung und automatische Veröffentlichung"
  - "Plattformgerechte Formate und Tonalität"
useCases:
  - "LinkedIn-Posts aus Firmen-Updates erstellen"
  - "Instagram Stories und Beiträge planen"
  - "Facebook-Updates automatisch veröffentlichen"
  - "Content-Kalender pflegen und umsetzen"
order: 8
relatedModules:
  - "newsletter"
  - "bewertungen"
  - "lead-qualifizierung"
faq:
  - question: "Kann ich Beiträge vor der Veröffentlichung prüfen?"
    answer: "Ja, der Workflow lässt sich so konfigurieren, dass jeder Beitrag erst nach deiner Freigabe veröffentlicht wird. Du behältst jederzeit die volle Kontrolle."
  - question: "Welche Plattformen werden unterstützt?"
    answer: "Aktuell LinkedIn, Instagram und Facebook. Weitere Plattformen wie TikTok oder X lassen sich bei Bedarf anbinden."
  - question: "Brauche ich trotzdem noch einen Social Media Manager?"
